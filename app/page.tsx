...
// Every request re-fetches the sheet directly -- no cache, no cron, no copy
// of the data anywhere else. Whatever is in the sheet after your latest
// rebalance is what renders here, on the next page load.
      ...
      <main className="relative mx-auto max-w-4xl px-6 py-12">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-50">
            RISHI MOMENTUM-10 — Forward Test
          </h1>
          <p className="mt-1.5 max-w-xl text-sm text-zinc-500 dark:text-zinc-400">
            10-stock, equal-weight momentum book on ₹1,00,00,000. Selection made outside this
            sheet; entry frozen once at first run, whole shares, weekly-Wednesday rebalance to
            equal weight, benchmarked against the Nifty 500.
          </p>
          {fetchedAt && (
